        ...
        <form onSubmit={handleSubmit} className="card">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div>
                ...
                <div className="relative group">
                  <Building2 className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-primary-600 transition-colors" />
                  <input
                    type="text"
                    required
                    value={formData.company}
                    onChange={(e) => handleChange('company', e.target.value)}
                    className="input pl-10 focus:border-primary-500 focus:ring-primary-500"
                    placeholder="Google"
                  />
                </div>
              </div>
          ...
          <div className="mt-8 flex gap-4">
            <button
              type="submit"
              disabled={saving}
              className="btn-primary disabled:opacity-50 disabled:cursor-not-allowed flex items-center gap-2 transform hover:scale-105 transition-all"
            >
              {saving ? (
                <>
            ...
            <button
              type="button"
              onClick={() => router.back()}
              className="btn-secondary transform hover:scale-105 transition-all"
              disabled={saving}
            >
              Cancel
            </button>
